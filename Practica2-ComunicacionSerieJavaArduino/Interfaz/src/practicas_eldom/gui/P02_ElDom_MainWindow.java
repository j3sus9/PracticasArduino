...
//	private 	SerialPort 				serialPort;	
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		JLabel labelApartadoPulsadores = new JLabel("Elija el apartado deseado:");
		labelApartadoPulsadores.setBounds(94, 53, 186, 13);
		panel_1.add(labelApartadoPulsadores);
		
		
		JComboBox<String> comboBoxApartadoPulsadores = new JComboBox<String>();
		comboBoxApartadoPulsadores.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					int aux = comboBoxApartadoPulsadores.getSelectedIndex();
					if(aux == 0) {
						commSerie.writeStringConsolePort("#1");
					}else if(aux == 1) {
						commSerie.writeStringConsolePort("#2");
					}else if(aux == 2) {
						commSerie.writeStringConsolePort("#3");
					}
		...
		comboBoxApartadoPulsadores.setToolTipText("Apartado 1\r\nApartado 2\r\nApartado 3");
		comboBoxApartadoPulsadores.setModel(new DefaultComboBoxModel<String>(new String[] {"Apartado 1", "Apartado 2", "Apartado 3"}));
		comboBoxApartadoPulsadores.setSelectedIndex(0);
		comboBoxApartadoPulsadores.setBounds(104, 76, 94, 21);
		panel_1.add(comboBoxApartadoPulsadores);
